...
💔 هلا عمري {message.from_user.mention()} !
        انا بوت اسمي [USERBot](t.me/{BOT_NAME}) استطيع تشغيل الاغاني في المكالمه المرئيه
يمكنني التشغيل بصوت رائع وبدون اي مشاكل او تقطيع في الاغنيه
 اضفني الى مجموعتك وامنحني الصلاحيات لكي اعمل بشكل صحيح

┣★   
┣★ [قم باضافتي مع البوت](t.me/OWNER_USERNAME)
┣★ او ارسل /انضم


 لمعرفة اوامر هذا البوت اضغط على زر الاوامر ان واجهة مشكلة تواصل مع المطور [السورس](t.me/OWNER_USERNAME)
━━━━━━━━━━━━━━━━━━**""",
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        "قناة البوت الرسمية", url="https://t.me/r55r1"
                    )]
            ]
       ),
    )
